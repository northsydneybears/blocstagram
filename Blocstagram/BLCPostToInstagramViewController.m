...
//  Blocstagram
//
//  Created by Peter Gow on 28/02/2015.
...
- (void)viewDidLoad
{
	...
	[self.filterCollectionView registerClass:[BLCFiltersCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
...
- (UICollectionViewCell*) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
	BLCFiltersCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
